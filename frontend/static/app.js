...
const TAG_SUGGESTIONS = {
  companies: [
    ...
    'Wells Fargo', 'BNP Paribas', 'Société Générale', 'Nomura', 'Mizuho Financial Group',
    'MUFG', 'SMBC', 'Sumitomo Mitsui Banking Corporation', 'RBC Capital Markets',
    'Standard Chartered', 'ING', 'Macquarie Group', 'NatWest', 'TD Securities',
    'BMO Capital Markets', 'Danske Bank', 'Nordea',
    // Elite Boutiques
    'Lazard', 'Evercore', 'Centerview Partners', 'PJT Partners', 'Perella Weinberg Partners',
    'Moelis & Company', 'Rothschild & Co', 'Greenhill & Co.', 'Guggenheim Securities',
    'LionTree Advisors', 'Zaoui & Co', 'Robey Warshaw', 'Allen & Company', 'M. Klein & Company',
    // Middle Market & Regional Banks
    'Jefferies', 'Houlihan Lokey', 'Raymond James', 'William Blair', 'Piper Sandler',
    'Baird', 'Stifel', 'Oppenheimer & Co.', 'Cowen & Company', 'Needham & Company',
    'Lincoln International', 'Harris Williams', 'Cantor Fitzgerald', 'Dyal Capital Partners',
    'Foros Group', 'Ardea Partners', 'Stephens Inc.', 'Janney Montgomery Scott',
    'Canaccord Genuity', 'KeyBanc Capital Markets', 'Truist Securities',
    'Regions Securities', 'PNC Capital Markets',
    'FTI Consulting', 'Alvarez & Marsal', 'Kroll', 'Duff & Phelps',
    // Asset Management
    'BlackRock', 'Vanguard', 'Fidelity Investments', 'State Street Global Advisors',
    'PIMCO', 'T. Rowe Price', 'Capital Group', 'Franklin Templeton',
    'Invesco', 'Wellington Management', 'Neuberger Berman', 'AllianceBernstein',
    'BNY Mellon Investment Management', 'Dodge & Cox', 'American Century Investments',
    'Federated Hermes', 'MFS Investment Management', 'Lord Abbett', 'Loomis Sayles',
    'Nuveen', 'Putnam Investments', 'PGIM', 'Jennison Associates',
    'ClearBridge Investments', 'Pzena Investment Management', 'VanEck',
    'Fiduciary Trust International', 'Silvercrest Asset Management Group',
    'Dimensional Fund Advisors', 'AQR Capital Management', 'Janus Henderson Investors',
    'Western Asset Management', 'Geode Capital Management', 'Northern Trust Asset Management',
    'Payden & Rygel', 'DoubleLine Capital', 'Harris Associates', 'TCW Group',
    'Wasatch Global Investors', 'Brown Advisory', 'Diamond Hill Capital Management',
    'Polen Capital Management', 'Sands Capital Management', 'Mondrian Investment Partners',
    'Ariel Investments', 'Brandes Investment Partners', 'Barings',
    'Calamos Investments', 'Artisan Partners', 'WCM Investment Management', 'GMO',
    'Harding Loevner', 'SEI Investments', 'Causeway Capital Management',
    'Fayez Sarofim & Co.', 'Fidelity International', 'Frontier Capital Management',
    'Raymond James Investment Management', 'S&P Global Market Intelligence',
    'Man Group', 'Eaton Vance', 'Cohen & Steers', 'Legg Mason',
    // Hedge Funds
    'Bridgewater Associates', 'Citadel', 'Citadel Securities', 'Two Sigma', 'D.E. Shaw',
    'Renaissance Technologies', 'Point72 Asset Management', 'Millennium Management',
    'Balyasny Asset Management', 'Schonfeld Strategic Advisors', 'ExodusPoint Capital Management',
    'Elliott Management', 'Third Point', 'Baupost Group', 'Viking Global Investors',
    'Tiger Global Management', 'Coatue Management', 'Lone Pine Capital',
    'Pershing Square Capital Management', 'Graham Capital Management', 'Caxton Associates',
    'Tudor Investment Corp', 'Paloma Partners', 'Bracebridge Capital', 'CQS',
    'Silver Point Capital', 'Davidson Kempner Capital Management', 'Rokos Capital Management',
    'Stone Ridge Asset Management', 'BlueCrest Capital Management', 'GoldenTree Asset Management',
    'RA Capital Management', 'Horizon Kinetics', 'Third Avenue Management',
    'Yacktman Asset Management', 'Farallon Capital Management', 'Mariner Investment Group',
    'Lansdowne Partners', 'Marshall Wace', 'Capula Investment Management',
    'Element Capital Management', 'BlueBay Asset Management', 'Ruffer LLP',
    'Eisler Capital', 'Man GLG', 'Anchorage Capital Group', 'Light Street Capital',
    'D1 Capital Partners', 'Egerton Capital', 'Orbis Investment Management',
    'Algebris Investments', 'Systematica Investments', 'Winton Group', 'Squarepoint Capital',
    'Greenlight Capital', 'Appaloosa Management', 'Glenview Capital Management',
    'Jana Partners', 'Starboard Value', 'ValueAct Capital', 'Icahn Enterprises',
    // Private Equity
    'Blackstone', 'KKR', 'Apollo Global Management', 'Carlyle Group', 'TPG',
    'Warburg Pincus', 'Bain Capital', 'Advent International', 'CVC Capital Partners',
    'Thoma Bravo', 'Vista Equity Partners', 'Silver Lake Partners', 'Hellman & Friedman',
    'Leonard Green & Partners', 'Clayton Dubilier & Rice', 'Ares Management',
    'Oaktree Capital Management', 'General Atlantic', 'Francisco Partners',
    'Cerberus Capital Management', 'Blue Owl Capital', 'HPS Investment Partners',
    'Sixth Street Partners', 'King Street Capital', 'Canyon Partners', 'Värde Partners',
    'Angelo Gordon', 'Centerbridge Partners', 'Sculptor Capital Management',
    'Avenue Capital Group', 'EQT Partners', 'Insight Partners', 'Summit Partners',
    'TA Associates', 'Bridgepoint', 'PAI Partners', 'GTCR', 'Veritas Capital',
    'HG Capital', 'Partners Group', 'Pantheon Ventures', 'Roark Capital Group',
    'Permira', 'Sun Capital Partners', 'American Securities', 'New Mountain Capital',
    'H.I.G. Capital', 'Audax Group', 'Golub Capital',
    // Market Making & Quantitative Trading
    'Jane Street', 'IMC Trading', 'Optiver', 'Flow Traders', 'DRW Trading',
    'Jump Trading', 'Hudson River Trading', 'Tower Research Capital', 'Virtu Financial',
    'SIG Susquehanna International Group', 'Old Mission Capital', 'Akuna Capital',
    'Belvedere Trading', 'Geneva Trading Group', 'PEAK6 Investments', 'Spot Trading',
    'Group One Trading', 'Wolverine Trading', 'CTC Trading', 'TransMarket Group',
    'Headlands Technologies', 'Teza Technologies', 'WorldQuant', 'Five Rings Capital',
    'Radix Trading', 'Volant Trading', 'Hard Eight Trading', 'XTX Markets',
    'G-Research', 'IMC Financial Markets', 'AlphaGrep Securities', 'Quantlab Financial',
    'Chronos Research', 'Aspect Capital', 'Qube Research & Technologies',
    'Two Sigma Securities',
    // Sovereign Wealth Funds & Pension Funds
    'GIC', 'Temasek', 'Abu Dhabi Investment Authority', 'Public Investment Fund',
    'Kuwait Investment Authority', 'Mubadala Investment Company',
    'Norges Bank Investment Management', 'CDPQ', 'CPP Investments',
    "Ontario Teachers' Pension Plan", 'PSP Investments', 'AustralianSuper', 'Future Fund',
    'CalPERS', 'CalSTRS',
    // Insurance & Diversified Financial Services
    'Prudential Financial', 'MetLife', 'AIG', 'AXA', 'Allianz', 'Swiss Re', 'Munich Re',
    'Manulife Financial', 'Sun Life Financial', 'Voya Financial',
    'AXA Investment Managers', 'Allianz Global Investors', 'Swiss Re Asset Management',
    'Legal & General Capital', 'Manulife Investment Management', 'Sun Life Asset Management',
    'Voya Investment Management', 'Generali Asset Management', 'Aegon Asset Management',
    'Guardian Life Insurance Company', 'New York Life Investments',
    'MassMutual Investments', 'Principal Global Investors',
    'Marsh McLennan', 'Aon', 'Willis Towers Watson',
    // Real Estate & Infrastructure
    'Brookfield Asset Management', 'Starwood Capital Group', 'Prologis',
    'CBRE Group', 'Jones Lang LaSalle', 'Cushman & Wakefield',
    'Hines', 'Related Companies', 'Tishman Speyer',
    // University Endowments & Foundations
    'Harvard Management Company', 'Yale Investments Office', 'Princeton Investment Company',
    'MIT Investment Management', 'Stanford Management Company', 'Commonfund', 'TIFF Advisory Services',
  ],
  titles: [
  ...
  locations: [
    ...
    'Charlotte, NC', 'Philadelphia, PA', 'Minneapolis, MN', 'Phoenix, AZ',
    'Austin, TX', 'Baltimore, MD', 'Pittsburgh, PA', 'Nashville, TN',
    'Salt Lake City, UT', 'Hartford, CT', 'Stamford, CT', 'Greenwich, CT',
    'Wilmington, DE', 'Kansas City, MO', 'St. Louis, MO', 'Columbus, OH',
    'Cleveland, OH', 'Cincinnati, OH', 'Indianapolis, IN', 'Milwaukee, WI',
    'Detroit, MI', 'Raleigh, NC', 'Richmond, VA', 'Jacksonville, FL',
    'Tampa, FL', 'Orlando, FL', 'San Diego, CA', 'Portland, OR',
  ],
  schools: [
    // Ivy League
    ...
    'Cornell University', 'Cornell University Samuel Curtis Johnson Graduate School of Management',
    'Dartmouth College', 'Dartmouth College Tuck School of Business',
    'Brown University', 'Brown University School of Professional Studies',
    // Top Universities
    'Massachusetts Institute of Technology', 'Massachusetts Institute of Technology Sloan School of Management',
    ...
    'Northwestern University', 'Northwestern University Kellogg School of Management',
    'Duke University', 'Duke University Fuqua School of Business',
    'University of Michigan', 'University of Michigan Ross School of Business',
    'Georgetown University', 'Georgetown University McDonough School of Business',
    'Georgetown University School of Foreign Service',
    'University of Notre Dame', 'University of Notre Dame Mendoza College of Business',
    'Vanderbilt University', 'Vanderbilt University Owen Graduate School of Management',
    'Emory University', 'Emory University Goizueta Business School',
    'Carnegie Mellon University', 'Carnegie Mellon University Tepper School of Business',
    'New York University', 'New York University Stern School of Business',
    'University of Virginia', 'University of Virginia Darden School of Business',
    'Washington University in St. Louis', 'Washington University in St. Louis Olin Business School',
    'Rice University', 'Rice University Jesse H. Jones Graduate School of Business',
    'Tufts University',
    'Boston University', 'Boston University Questrom School of Business',
    'Boston College', 'Boston College Carroll School of Management',
    'Northeastern University',
    'University of Southern California', 'University of Southern California Marshall School of Business',
    'University of California Los Angeles', 'University of California Los Angeles Anderson School of Management',
    'University of California Berkeley', 'University of California Berkeley Haas School of Business',
    'University of California San Diego', 'University of California San Diego Rady School of Management',
    'Johns Hopkins University', 'Johns Hopkins University Carey Business School',
    'American University', 'American University Kogod School of Business',
    'George Washington University', 'George Washington University School of Business',
    'George Mason University',
    'William and Mary', 'College of William and Mary Mason School of Business',
    'Wake Forest University', 'Wake Forest University School of Business',
    'University of North Carolina', 'University of North Carolina Kenan-Flagler Business School',
    'North Carolina State University',
    'University of Georgia', 'University of Georgia Terry College of Business',
    'Georgia Institute of Technology', 'Georgia Institute of Technology Scheller College of Business',
    'University of Florida', 'University of Florida Warrington College of Business',
    'Florida State University',
    'University of Miami',
    'University of Texas at Austin', 'University of Texas at Austin McCombs School of Business',
    'Texas A&M University', 'Texas A&M University Mays Business School',
    'Southern Methodist University', 'Southern Methodist University Cox School of Business',
    'Baylor University', 'Baylor University Hankamer School of Business',
    'Tulane University', 'Tulane University Freeman School of Business',
    'University of Illinois Urbana-Champaign', 'University of Illinois Urbana-Champaign Gies College of Business',
    'University of Wisconsin Madison', 'University of Wisconsin Madison Wisconsin School of Business',
    'Purdue University', 'Purdue University Krannert School of Management',
    'Indiana University', 'Indiana University Kelley School of Business',
    'Ohio State University', 'Ohio State University Fisher College of Business',
    'University of Minnesota', 'University of Minnesota Carlson School of Management',
    'Michigan State University', 'Michigan State University Broad College of Business',
    'Penn State University', 'Penn State University Smeal College of Business',
    'University of Maryland', 'University of Maryland Robert H. Smith School of Business',
    'University of Pittsburgh', 'University of Pittsburgh Katz Graduate School of Business',
    'Fordham University', 'Fordham University Gabelli School of Business',
    'Baruch College', 'Baruch College Zicklin School of Business',
    'Lehigh University',
    'Villanova University', 'Villanova University School of Business',
    'Bucknell University',
    'Colgate University',
    'Hamilton College',
    'Lafayette College',
    ...
    'Holy Cross College',
    'University of Rochester', 'University of Rochester Simon Business School',
    'Case Western Reserve University', 'Case Western Reserve University Weatherhead School of Management',
    'Babson College',
    'Bentley University',
    'Bryant University',
    ...
    'University of Delaware', 'University of Delaware Alfred Lerner College of Business and Economics',
    'Drexel University', 'Drexel University LeBow College of Business',
    'Temple University', 'Temple University Fox School of Business',
    'Rutgers University', 'Rutgers University Business School',
    'Seton Hall University', 'Seton Hall University Stillman School of Business',
    ...
    'Pitzer College',
    'Occidental College',
    'Pepperdine University', 'Pepperdine University Graziadio Business School',
    'Santa Clara University', 'Santa Clara University Leavey School of Business',
    'University of San Diego',
    'Loyola Marymount University',
    'University of California Santa Barbara',
    'University of California Davis', 'University of California Davis Graduate School of Management',
    'University of California Irvine', 'University of California Irvine Paul Merage School of Business',
    'University of California Santa Cruz',
    'University of Colorado Boulder', 'University of Colorado Boulder Leeds School of Business',
    'Colorado College',
    'University of Denver', 'University of Denver Daniels College of Business',
    'Brigham Young University', 'Brigham Young University Marriott School of Business',
    'University of Utah', 'University of Utah David Eccles School of Business',
    'University of Arizona', 'University of Arizona Eller College of Management',
    'Arizona State University', 'Arizona State University W. P. Carey School of Business',
    'University of Oregon', 'University of Oregon Lundquist College of Business',
    'University of Washington', 'University of Washington Foster School of Business',
    'Gonzaga University',
    'Whitman College',
    'Reed College',
    // Midwest
    'University of Iowa', 'University of Iowa Tippie College of Business',
    'Iowa State University',
    'University of Missouri', 'University of Missouri Trulaske College of Business',
    'University of Kansas', 'University of Kansas School of Business',
    'University of Nebraska Lincoln', 'University of Nebraska Lincoln College of Business',
    'University of Oklahoma', 'University of Oklahoma Price College of Business',
    'Oklahoma State University', 'Oklahoma State University Spears School of Business',
    'DePaul University', 'DePaul University Kellstadt Graduate School of Business',
    'Loyola University Chicago', 'Loyola University Chicago Quinlan School of Business',
    'Marquette University', 'Marquette University College of Business Administration',
    'Grinnell College',
    'Carleton College',
    'Macalester College',
    'Saint Olaf College',
    ...
    'DePauw University',
    'Butler University',
    'Miami University', 'Miami University Farmer School of Business',
    'University of Cincinnati', 'University of Cincinnati Lindner College of Business',
    // South
    'University of Arkansas', 'University of Arkansas Sam M. Walton College of Business',
    'University of Alabama', 'University of Alabama Culverhouse College of Business',
    'Auburn University', 'Auburn University Harbert College of Business',
    'Louisiana State University', 'Louisiana State University E. J. Ourso College of Business',
    'University of South Carolina', 'University of South Carolina Darla Moore School of Business',
    'Clemson University', 'Clemson University College of Business',
    'University of Mississippi',
    'University of Kentucky', 'University of Kentucky Gatton College of Business and Economics',
    'University of Louisville',
    'University of Tennessee', 'University of Tennessee Haslam College of Business',
    'University of Memphis', 'University of Memphis Fogelman College of Business and Economics',
    'Rhodes College',
    'Elon University', 'Elon University Martha and Spencer Love School of Business',
    'High Point University',
    'Florida International University', 'Florida International University College of Business',
    'University of Tampa',
    'Stetson University',
    // Virginia & Mid-Atlantic
    'Virginia Tech', 'Virginia Tech Pamplin College of Business',
    'James Madison University', 'James Madison University College of Business',
    'University of Richmond', 'University of Richmond Robins School of Business',
    'Loyola University Maryland', 'Loyola University Maryland Sellinger School of Business and Management',
    // New York State
    'Rensselaer Polytechnic Institute', 'Rensselaer Polytechnic Institute Lally School of Management',
    'University at Buffalo', 'University at Buffalo School of Management',
    'Binghamton University', 'Binghamton University School of Management',
    ...
    'Ithaca College',
    'Hofstra University', 'Hofstra University Frank G. Zarb School of Business',
    'Pace University', 'Pace University Lubin School of Business',
    'Marist College',
    'Manhattan College',
    'Iona University',
    // New England
    'University of Massachusetts Amherst', 'University of Massachusetts Amherst Isenberg School of Management',
    'Clark University',
    ...
    'Duquesne University', 'Duquesne University Palumbo Donahue School of Business',
    "Saint Joseph's University", "Saint Joseph's University Haub School of Business",

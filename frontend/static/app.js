...
const TAG_SUGGESTIONS = {
  companies: [
    ...
    'Wells Fargo', 'BNP Paribas', 'Societe Generale', 'Nomura', 'Mizuho Financial Group',
    'MUFG', 'Sumitomo Mitsui Banking Corporation',
    // Elite Boutiques
    'Lazard', 'Evercore', 'Centerview Partners', 'PJT Partners', 'Perella Weinberg Partners',
    'Moelis and Company', 'Rothschild and Company', 'Greenhill and Company', 'Guggenheim Partners',
    'LionTree', 'Zaoui and Company', 'Ondra Partners',
    // Middle Market & Regional Banks
    'Jefferies', 'Houlihan Lokey', 'Raymond James', 'William Blair', 'Piper Sandler',
    'Baird', 'Stifel', 'Oppenheimer Holdings', 'Cowen', 'Needham and Company',
    'Imperial Capital', 'Lincoln International', 'Harris Williams', 'Duff and Phelps',
    'FTI Consulting', 'Alvarez and Marsal', 'Kroll', 'Stout',
    ...
    'Thoma Bravo', 'Vista Equity Partners', 'Silver Lake Partners', 'Hellman and Friedman',
    'Leonard Green and Partners', 'Clayton Dubilier and Rice', 'Ares Management',
    'Oaktree Capital Management', 'General Atlantic', 'Francisco Partners',
    // Private Equity - Mid Market
    'Cerberus Capital Management', 'Sun Capital Partners', 'American Securities',
    'CCMP Capital', 'Genstar Capital', 'Welsh Carson Anderson and Stowe',
    'New Mountain Capital', 'Riverside Company', 'H.I.G. Capital',
    'Audax Group', 'Golub Capital', 'Monroe Capital', 'Maranon Capital',
    // Hedge Funds
    'Bridgewater Associates', 'Citadel', 'Two Sigma', 'D.E. Shaw', 'Renaissance Technologies',
    'Point72 Asset Management', 'Millennium Management', 'Elliott Management',
    'Third Point', 'Baupost Group', 'Viking Global Investors', 'Tiger Global Management',
    'Coatue Management', 'Lone Pine Capital', 'Pershing Square Capital Management',
    ...
    'Man Group', 'AQR Capital Management', 'Winton Group',
    // Asset Management
    'BlackRock', 'Vanguard', 'Fidelity Investments', 'State Street Global Advisors',
    'PIMCO', 'T. Rowe Price', 'Capital Group', 'Franklin Templeton',
    'Invesco', 'Nuveen', 'Neuberger Berman', 'AllianceBernstein',
    'Dodge and Cox', 'American Century Investments', 'Federated Hermes',
    'Wellington Management', 'Putnam Investments', 'Eaton Vance',
    'MFS Investment Management', 'Lord Abbett', 'Loomis Sayles',
    'Cohen and Steers', 'Legg Mason', 'Affiliated Managers Group',
    // Real Estate & Infrastructure
    'Brookfield Asset Management', 'Starwood Capital Group', 'Prologis',
    'CBRE Group', 'Jones Lang LaSalle', 'Cushman and Wakefield',
    'Hines', 'Related Companies', 'Tishman Speyer', 'Rockpoint Group',
    // Credit & Alternatives
    'GSO Capital Partners', 'Benefit Street Partners', 'HPS Investment Partners',
    'Owl Rock Capital', 'Blue Owl Capital', 'Sixth Street Partners',
    'Marathon Asset Management', 'King Street Capital', 'Davidson Kempner Capital',
    // Insurance & Financial Services
    'MetLife', 'Prudential Financial', 'AIG', 'Marsh McLennan', 'Aon',
    'Willis Towers Watson', 'Lincoln Financial Group', 'Principal Financial Group',
    'Aflac', 'Hartford Financial Services',
    // Financial Infrastructure
    'Visa', 'Mastercard', 'American Express', 'PayPal', 'Square',
    'Charles Schwab', 'Fidelity National Information Services', 'Broadridge Financial Solutions',
    'Intercontinental Exchange', 'CME Group', 'Nasdaq', 'Bloomberg',
  ],
  titles: [
